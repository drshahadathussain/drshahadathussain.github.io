# Dr. Shahadat Hussain - Research Portfolio
...
Professional research portfolio website for Dr. Shahadat Hussain, showcasing expertise in:
...
4. **Customize Content**
   ...
   - Update publications and experience as needed
...
- **Home**: Introduction with photo
- **Research**: Focus areas with icons
- **Experience**: Timeline view
- **Publications**: Recent papers with links
- **Skills**: Technical expertise
- **Contact**: Professional contact info

## 🎨 Customization

1. Change colors in `style.css` (lines 12-18)
2. Update social links in `index.html`
3. Modify section content in respective HTML sections
